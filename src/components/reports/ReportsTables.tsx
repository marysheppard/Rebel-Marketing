...
export function ClientProfitTable({ rows }: { rows: ProfitRow[] }) {
  ...
  return (
    <section id="client-profit" className="rounded-box border border-base-300 bg-base-100 shadow-sm">
      <div className="flex flex-col gap-3 border-b border-base-300 px-4 py-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h2 className="text-lg font-bold text-[#0b1f3a]">Client profitability</h2>
          <p className="text-sm opacity-65">Revenue, cost, and margin by account</p>
        </div>
...
export function CampaignProfitTable({ rows }: { rows: ProfitRow[] }) {
  ...
  return (
    <section className="rounded-box border border-base-300 bg-base-100 shadow-sm">
      <div className="flex flex-col gap-3 border-b border-base-300 px-4 py-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h2 className="text-lg font-bold text-[#0b1f3a]">Campaign profitability</h2>
          <p className="text-sm opacity-65">Where delivery dollars turn into margin</p>
        </div>
        <div className="flex flex-wrap gap-2">
          <input
...
export function BudgetTable({ rows }: { rows: BudgetRow[] }) {
  ...
  return (
    <section id="budget" className="rounded-box border border-base-300 bg-base-100 shadow-sm">
      <div className="flex flex-col gap-3 border-b border-base-300 px-4 py-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h2 className="text-lg font-bold text-[#0b1f3a]">Budget performance</h2>
          <p className="text-sm opacity-65">Spend vs approved campaign budgets</p>
        </div>
        <div className="flex flex-wrap gap-2">
          <select
            className="select select-bordered select-sm"
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-2" id="approvals">
      <section className="rounded-box border border-base-300 bg-base-100 p-5 shadow-sm">
        <h2 className="text-lg font-bold text-[#0b1f3a]">Billing performance</h2>
        <p className="mt-0.5 text-sm opacity-65">Cash collected vs still open</p>
      ...
      <section className="rounded-box border border-base-300 bg-base-100 p-5 shadow-sm">
        <h2 className="text-lg font-bold text-[#0b1f3a]">Approval + unbilled</h2>
        <p className="mt-0.5 text-sm opacity-65">Pipeline health and invoice-ready work</p>
        <div className="mt-4 grid grid-cols-2 gap-3">
